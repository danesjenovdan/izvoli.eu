...
DATABASE_NAME="izvoli_eu"
K8S_NAMESPACE="izvoli-eu"
SECRETS_NAME="izvoli-credentials"
...
# docker container exec -i $(docker-compose ps -q db) psql -U postgres izvoli < db.dump
